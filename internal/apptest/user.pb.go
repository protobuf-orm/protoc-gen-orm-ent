...
const file_apptest_user_proto_rawDesc = "" +
	"\n" +
	"\x12apptest/user.proto\x12\aapptest\x1a\x14apptest/tenant.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\torm.proto\"\x97\x03\n" +
	"\x04User\x12 \n" +
	"\x02id\x18\x01 \x01(\fB\x10\xea\x82\x16\a\x10@(\x01\x82\x01\x00\xaa\x01\x02\b\x02R\x02id\x12'\n" +
	...
	"\n" +
	"\x06tenant\x10\x020\x01B=Z;github.com/protobuf-orm/protoc-gen-orm-ent/internal/apptestb\beditionsp\xe8\a"
